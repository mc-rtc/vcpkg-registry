## # vcpkg_find_fortran_for_subdirectory
##
...
## ## Usage
## ```cmake
## vcpkg_find_fortran_for_subdirectory(<additional_cmake_args_out>
## )
## ```

function(vcpkg_find_fortran_for_subdirectory additional_cmake_args_out)
    set(ARGS_OUT)
    ...
    # or setup fortran in their VCPKG_CHAINLOAD_TOOLCHAIN_FILE themselfs!
        if(WIN32)
            ...
            if(VCPKG_TARGET_ARCHITECTURE STREQUAL "x86")
                ...
                vcpkg_acquire_msys(MSYS_ROOT
                    DIRECT_PACKAGES
                        ...
                        "https://repo.msys2.org/mingw/i686/mingw-w64-i686-expat-2.2.9-1-any.pkg.tar.xz"
                        495e4f08da2456e71f4f4a699c59f1763ebc2bcf86e8ab8fcf33c070e0c859aa336a7d5eb3848ca7fcd4af8791901edc70222c0558c1e028c90555338e94a09c
            ...
            elseif(VCPKG_TARGET_ARCHITECTURE STREQUAL "x64")
                ...
                vcpkg_acquire_msys(MSYS_ROOT
                    DIRECT_PACKAGES
                        ...
                        "https://repo.msys2.org/mingw/x86_64/mingw-w64-x86_64-gettext-0.19.8.1-9-any.pkg.tar.zst"
                        571a36cf60e40172aaa7a5a40b1db60bbea145d9f399603a625a57ca106679f6feb53fda73d935ce8f0057935cad5b9a8770ae4f065e54e1554a1932b48eec97
                        "https://repo.msys2.org/mingw/x86_64/mingw-w64-x86_64-expat-2.2.9-1-any.pkg.tar.xz"
                        1f747b9c7e6ee680b6d8f76429e81a42e2d4ab72d5d930207c90f4513cca5158c08c8296889fd27fe07a275cdeff5d34b5de0e6d1cd982d2e1d05765d6c8c31a
            ...
            set(vcpkg_find_fortran_for_subdirectory_MSYS_ROOT "${MSYS_ROOT}" PARENT_SCOPE)
